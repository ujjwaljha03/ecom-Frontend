...
const Product = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await axios.get(
          `https://ecom-backened-production.up.railway.app/api/product/${id}`
        );
    ...
    const fetchImage = async () => {
      const response = await axios.get(
        `https://ecom-backened-production.up.railway.app/api/product/${id}/image`,
        { responseType: "blob" }
      );
  ...
  const deleteProduct = async () => {
    try {
      await axios.delete(`https://ecom-backened-production.up.railway.app/api/product/${id}`);
      removeFromCart(id);
  ...
  const handlAddToCart = () => {
    // addToCart(product);                           // CART not working !!!!!
    // alert("Product added to cart");
    alert(" Cart is under Maintenance !");
  };
  if (!product) {
    return (
