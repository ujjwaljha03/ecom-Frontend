...
const Navbar = ({ onSelectCategory, onSearch }) => {
  ...
  const fetchData = async (value) => {
    try {
      const response = await axios.get("https://ecom-backened-production.up.railway.app/api/products");
  ...
  const handleChange = async (value) => {
    ...
    try {
      const response = await axios.get(
        `https://ecom-backened-production.up.railway.app/api/products/search?keyword=${value}`
      );
      setSearchResults(response.data);
      ...
      <header>
        <nav className="navbar navbar-expand-lg fixed-top">
          <div className="container-fluid">
            <a className="navbar-brand" target="_blank" href="https://www.instagram.com/u.jj.wal_/">
              Ujjwal
            </a>
            <button
